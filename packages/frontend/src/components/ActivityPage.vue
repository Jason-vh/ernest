            ...
            <div class="overflow-hidden rounded-xl border border-black/6 bg-white">
              ...
              >
                ...
                <div class="min-w-0 flex-1">
                  ...
                  <div
                    class="mt-0.5 flex items-center justify-between gap-2 text-[12px] text-[#888]"
                  >
                    ...
                    <span
                      class="flex-shrink-0 rounded-full bg-black/6 px-1.5 py-0.5 text-[10px] font-medium text-[#777]"
